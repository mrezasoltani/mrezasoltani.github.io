...
* For solving a problem using ML techniques, we alsways need to have data. In fact, data is one of the most important pieces in all ML algorithm/methods. Beforejumping to the ML concept, we need to introduce some terminologies regarding the data.
