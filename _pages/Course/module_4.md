...
* The common risk minimization are given the by _mean absolute values_ risk by choosing the loss function as the \\(\el_1\\ loss, and the _mean squared error_ by choosing the loss function as the \\(\el_2\\ loss.
