...
* In general, there are two approaches for statistical problems: parametric methods and non-parametric methods. parametric methods assume that the underlying distribution of data has a fixed number of parameters, while non-parametric methods are based on the assumption that the number of parameters of the underlying distribution grows with the number of data samples. 
